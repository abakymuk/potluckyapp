...
describe('API Routes', () => {
  ...
  describe('/api/menu', () => {
    it('should return 404 when ONLINE_ORDERING_V1 is disabled', async () => {
      ...
      const request = new NextRequest(new URL('http://localhost/api/menu'))
  ...
  describe('/api/price', () => {
    it('should return 404 when ONLINE_ORDERING_V1 is disabled', async () => {
      ...
      const request = new NextRequest(new URL('http://localhost/api/price'), {
        method: 'POST',
        body: JSON.stringify({}),
      })
      const response = await postPrice(request)
  ...
  describe('/api/cart/validate', () => {
    it('should return 404 when ONLINE_ORDERING_V1 is disabled', async () => {
      ...
      const request = new NextRequest(new URL('http://localhost/api/cart/validate'), {
        method: 'POST',
        body: JSON.stringify({}),
      })
      const response = await postCartValidate(request)
